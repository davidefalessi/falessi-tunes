...
@Singleton
public final class AuthorHandler
    extends AbstractEntityHandler<Author>
{

    protected Author toEntity(ResultSet rs)
        throws SQLException
    {
        Author author = new Author();
        author.setId( rs.getLong( "id" ) );
        author.setName( rs.getString( "name" ) );
        author.setBornDate( rs.getDate( "born_date" ) );
        author.setGender( rs.getString( "gender" ) );
        author.setRecordingLabel( rs.getString( "label" ) );
